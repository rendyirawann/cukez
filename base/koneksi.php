...
{
    global $conn;
    mysqli_query($conn, "DELETE FROM riwayat_se WHERE id = $id");
    // mysqli_query($conn, "UPDATE riwayat_se set id = id-1 WHERE id > $id");
    // mysqli_query($conn, "ALTER TABLE riwayat_se AUTO_INCREMENT = 1");
